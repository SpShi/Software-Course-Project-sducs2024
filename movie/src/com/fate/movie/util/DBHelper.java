...
public class DBHelper {
    ...
    //创建c3p0数据源对象
    static ComboPooledDataSource ds = new ComboPooledDataSource("mysql-movie");
    ...
    public static void main(String[] args) {
		//测试数据库的连接情况
        try {
            Connection connection = com.fate.movie.util.DBHelper.getConnection();
