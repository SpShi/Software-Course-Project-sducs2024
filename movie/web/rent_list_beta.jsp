            ...
            $("#btnQuery").click(function(){
                ...
                $.get(url,function(data){
                    ...
                    for(var i=0;i<records.length;i++){
                        ...
                        var tdBName = $("<td>"+record.movieName+"</td>");
                        var tdBuyDate=new Date(record.buyDate).toLocaleString();
                        var BackDate=new Date(record.backDate).toLocaleString();
                        //var tdBuyDate = $("<td>"+record.buyDate+"</td>");
                        var tdBackDate = $("<td>"+ (record.backDate===undefined?"":BackDate)+"</td>");
                        var tdDeposit = $("<td>"+record.deposit+"</td>");
                        var tdchamberId = $("<td>"+record.cid+"</td>");
                        var tdseat = $("<td>"+record.seat+"</td>");
                        //5-td
                        tr.append(tdMName);
                        tr.append(tdBName);
                        tr.append(tdBuyDate);
                    ...
                    <td colspan="4">
                        <table>
                            <tr>
                                ...
                                <td valign="bottom"><h3 style="letter-spacing:1px;">常用功能 > 购买历史记录 </h3></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                            ...
                            <table width="100%" class="cont"  >
                                <tr>
                                    <td colspan="8" align="center">
                                        ...
                                        <input type="radio" name="query" value="1"/>已结束 &nbsp;&nbsp;
                                        <input type="radio" name="query" value="2"/>未观看 &nbsp;&nbsp;
                                        <input type="radio" name="query" value="3"/>最近一天需上演 &nbsp;&nbsp;
