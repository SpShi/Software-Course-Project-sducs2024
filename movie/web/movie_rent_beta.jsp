                    ...
                    <td width="96%">
                        <fieldset>
                            ...
                            <table width="100%" border="0" class="cont"  >
                                <tr>
                                    <td width="8%" class="run-right"> 确认身份证号</td>
                                    <td colspan="7"><input class="text" type="text" id="memberId" name="memberId"value="${user.idNumber}" disabled/>
                                        <input type="button" id="btnQuery" value="确认" style="width: 80px;"/></td>
