...
<table width="100%" height="200" border="0" cellpadding="0" cellspacing="0" >
    <tr>
        <td width="182" valign="top">
            <div id="container">
                <h1 class="type"><a href="javascript:void(0)"> 电影</a></h1>
                <div class="content">
                ...
                <h1 class="type"><a href="javascript:void(0)"> 影厅</a></h1>
                <div class="content">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><img src="./Images/menu_top_line.gif" width="182" height="5" /></td>
                ...
                <div class="content">
                    ...
                    <ul class="RM">
                        <li><a href="./movie_rent_beta.jsp" target="main"> 电影购票</a></li>
                        <li><a href="./return_list_beta.jsp" target="main"> 退票</a></li>
                        <li><a href="./rent_list_beta.jsp" target="main">查看购票历史信息</a></li>
                    </ul>
                </div>
                <!-- *********** -->
                ...
                <div class="content">
                    ...
                    <ul class="RM">
                        <li><a href="./set_pwd_beta.jsp" target="main">修改密码</a></li>
