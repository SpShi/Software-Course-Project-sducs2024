                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;">电影添加 > 添加电影</h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="96%">
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="movie.let?type=add" method="post" enctype="multipart/form-data">
                                                <table width="100%"class="cont">
                                                    ...
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td>上映日期:</td>
                                                        <td width="20%"><input class="text" type="datetime-local"  name="date"/>
                                                        </td>
                                                        <td></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>影厅号:</td>
                                                        <td width="20%">
                                                            <select id="chamber_type"  name="address">
                                                                <option value="0">---请选择---</option>
                                                                <c:forEach items="${chambers}" var="cb">
