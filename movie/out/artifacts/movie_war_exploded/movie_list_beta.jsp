                    ...
                    <td colspan="4">
                        <table>
                            <tr>
                                ...
                                <td valign="bottom"><h3 style="letter-spacing:1px;">电影添加 > 电影列表 </h3></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <table width="100%"  class="cont tr_color">
                                        ...
                                        <tr><td colspan="9" align="center">
                                            <div class="pager">
                                                <ul class="clearfix">
                                                    <li><a href="movie.let?type=query&pageIndex=${param.pageIndex-1}">上一页</a></li>
                                                    <c:forEach var="i" begin="1" end="${pageCount}" step="1">
                                                        <c:if test="${i==param.pageIndex}">
                                                            <li class="current"><a href="movie.let?type=query&pageIndex=${i}">${i}</a></li>
                                                        </c:if>
                                                        <c:if test="${i!=param.pageIndex}">
                                                            <li><a href="movie.let?type=query&pageIndex=${i}">${i}</a></li>
                                                        </c:if>
                                                    </c:forEach>
                                                    <li><a href="movie.let?type=query&pageIndex=${param.pageIndex+1}">下一页</a></li>
                                                </ul>
                                            </div>
                                        </td></tr>
                                    </table>
